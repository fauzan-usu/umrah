...
if (isset($_POST['simpan'])) {
    ...
    logAktivitas($conn, $user_id, 'Tambah Pembayaran', "Kwitansi: $kwitansi, Jumlah: $jumlah");
...
// Data
$where = $filter_jamaah ? "WHERE pb.jamaah_id = $filter_jamaah" : "";
$pembayaran = $conn->query("
    SELECT pb.*, j.nama_lengkap, j.kode_jamaah, j.harga_paket, u.nama as nama_sales,
    (SELECT SUM(jumlah_bayar) FROM pembayaran WHERE jamaah_id = j.id) as total_terbayar
    FROM pembayaran pb 
...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a href="pembayaran.php" class="nav-link active"><i class="fas fa-money-bill-wave me-2"></i> Pembayaran</a>
    ...
    <div class="main-content">
        <div class="topbar d-flex justify-content-between align-items-center">
            <div><h5 class="mb-0">Manajemen Pembayaran</h5></div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card-table p-4">
                    <h6 class="mb-3 fw-bold"><i class="fas fa-plus-circle me-2 text-success"></i>Input Pembayaran</h6>
                    <form method="POST">
                        <div class="mb-3">
            ...
            <div class="col-md-8">
                <div class="card-table">
                    <div class="p-4 border-bottom">
                        <h6 class="mb-0 fw-bold"><i class="fas fa-list me-2 text-success"></i>Riwayat Pembayaran</h6>
                    </div>
                    <div class="table-responsive p-3">
                        <table class="table table-hover">
                            <thead class="table-light">
                                <tr>
                                    <th>No. Kwitansi</th><th>Tanggal</th><th>Jamaah</th><th>Jenis</th>
                                    <th>Jumlah</th><th>Metode</th><th>Sales</th><th>Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <script>
        function updateInfo() {
            ...
            if (select.value) {
                ...
                document.getElementById('jumlah_bayar').max = option.dataset.sisa;
            } else {
